...
def main(args):
    ...
    track = np.load(f'{args.result_dir}/track-bl.npy', allow_pickle=True).item()
...
def track(video_name):
    ...
    args.imgdir = f'in_the_wild_data/split_{video_name}'
    args.result_dir = f'in_the_wild_data/alphapose_{video_name}'
